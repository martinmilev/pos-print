...
public class FP705PrinterTest {
  ...
  public void printReceiptWithSingleItem() throws Exception {
    ...
    fakeFP705.prepareFlows(
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3B, 0x22, 0x30, 0x30, 0x32, 0x3A, 0x09, 0x05, 0x30, 0x31, 0x3C,
          0x39, 0x03
        },
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x35, 0x22, 0x30, 0x30, 0x32, 0x3A, 0x30, 0x09, 0x04, (byte) 0x80,
          (byte) 0x80, (byte) 0xA0, (byte) 0x80, (byte) 0x86, (byte) 0x9A, (byte) 0x80, (byte) 0x80,
          0x05, 0x30, 0x36, 0x33, 0x38, 0x03
        }
      ),
      // Print empty line
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3B, 0x23, 0x30, 0x30, 0x32, 0x3A, 0x09, 0x05, 0x30, 0x31, 0x3C,
          0x3A, 0x03
        },
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x35, 0x23, 0x30, 0x30, 0x32, 0x3A, 0x30, 0x09, 0x04, (byte) 0x80,
          (byte) 0x80, (byte) 0xA0, (byte) 0x80, (byte) 0x86, (byte) 0x9A, (byte) 0x80, (byte) 0x80,
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x34, 0x32, 0x24, 0x30, 0x30, 0x32, 0x3A, (byte) 0xD0, (byte) 0xE5,
          (byte) 0xE4, 0x20, 0x31, 0x20, 0x2D, 0x20, 0x31, 0x2E, 0x30, 0x30, 0x20, 0x58, 0x20, 0x30,
          0x2E, 0x31, 0x30, 0x20, 0x42, 0x47, 0x4E, 0x09, 0x05, 0x30, 0x38, 0x32, 0x38, 0x03
        },
        new byte[]{
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x39, 0x27, 0x30, 0x30, 0x32, 0x3A, (byte) 0xCE, (byte) 0xE1,
          (byte) 0xF9, (byte) 0xEE, 0x3A, 0x20, 0x30, 0x2E, 0x31, 0x30, 0x20, 0x42, 0x47, 0x4E, 0x09,
          0x05, 0x30, 0x37, 0x37, 0x33, 0x03
        },
        new byte[]{
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3A, 0x28, 0x30, 0x30, 0x32, 0x37, 0x05, 0x30, 0x31, 0x3C, 0x32,
          0x03
        },
        new byte[]{
  ...
  public void printReceipt() throws Exception {
    ...
    fakeFP705.prepareFlows(
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3B, 0x22, 0x30, 0x30, 0x33, 0x36, 0x09, 0x05, 0x30, 0x31, 0x3C, 0x36, 0x03
        },
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x35, 0x22, 0x30, 0x30, 0x33, 0x36, 0x30, 0x09, 0x04, (byte) 0x80,
          (byte) 0x80, (byte) 0x88, (byte) 0x80, (byte) 0x86, (byte) 0x9A, (byte) 0x80, (byte) 0x80,
          0x05, 0x30, 0x36, 0x31, 0x3D, 0x03
        }
      ),
      // Print FISCAL ITEM
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x34, 0x36, 0x23, 0x30, 0x30, 0x33, 0x31, 0x48, 0x53, 0x49, 0x20, 0x38,
          0x30, 0x2F, 0x34, 0x30, 0x09, 0x31, 0x09, 0x30, 0x2E, 0x31, 0x30, 0x09, 0x31, 0x2E, 0x30,
          0x30, 0x30, 0x09, 0x30, 0x09, 0x09, 0x30, 0x09, 0x05, 0x30, 0x36, 0x33, 0x33, 0x03
        },
        new byte[]{
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3B, 0x24, 0x30, 0x30, 0x33, 0x36, 0x09, 0x05, 0x30, 0x31, 0x3C, 0x38, 0x03
        },
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x35, 0x22, 0x30, 0x30, 0x33, 0x36, 0x30, 0x09, 0x04, (byte) 0x80,
          (byte) 0x80, (byte) 0x88, (byte) 0x80, (byte) 0x86, (byte) 0x9A, (byte) 0x80, (byte) 0x80,
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x32, 0x25, 0x30, 0x30, 0x33, 0x36, (byte) 0xCB, (byte) 0xE8,
          (byte) 0xED, (byte) 0xE8, (byte) 0xFF, 0x20, 0x32, 0x09, 0x05, 0x30, 0x36, 0x39, 0x3A,
          0x03
        },
        new byte[]{
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x31, 0x26, 0x30, 0x30, 0x33, 0x35, 0x30, 0x09, 0x30, 0x2E, 0x31,
          0x30, 0x09, 0x05, 0x30, 0x32, 0x3B, 0x38, 0x03
        },
        new byte[]{
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3A, 0x26, 0x30, 0x30, 0x33, 0x38, 0x05, 0x30, 0x31, 0x3C,
          0x32, 0x03
        },
        new byte[]{
  ...
  @Test
  public void testFiscalBehave() throws IOException {
    ...
    printer.printReceipt(newReceipt()
      ...
      .suffixLines(Collections.singletonList("Линия 2"))
      .addItems(
        newItem().name("TEXT 80/40").quantity(1d).price(0.10d).build()
      ).build());

//
//    printer.printFiscalReceipt(newReceipt()
//      .prefixLines(Collections.singletonList(
//        "Линия 1"
//      ))
//      .suffixLines(Collections.singletonList("Линия 2"))
...
//      ).build());
  ...
  public void printReceiptAndGetNearEndOfPaper() throws Exception {
    ...
    fakeFP705.prepareFlows(
      ...
      new Flow(
        new byte[]{
          0x01, 0x30, 0x30, 0x32, 0x3A, 0x20, 0x30, 0x30, 0x32, 0x36, 0x05, 0x30, 0x31, 0x3B, 0x39, 0x03
        },
        new byte[]{
          0x01, 0x30, 0x30, 0x33, 0x39, 0x20, 0x30, 0x30, 0x33, 0x30, 0x30, 0x09, 0x31, 0x36, 0x32,
          0x09, 0x04,
